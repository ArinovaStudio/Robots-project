...
-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('SPAM', 'NUDITY_OR_SEXUAL_CONTENT', 'HATE_SPEECH', 'HARASSMENT', 'VIOLENCE', 'COPYRIGHT_VIOLATION', 'OTHER');
...
CREATE TABLE "CompanyProfile" (
    ...
    "location" TEXT,
    "lookingFor" TEXT[],
    "offeringVector" vector(768),
    "needsVector" vector(768),
    "isBoosted" BOOLEAN NOT NULL DEFAULT false,
    "exchangeDataset" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Plan" (
    ...
    "givesBoost" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "SearchImpressionStat" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "date" DATE NOT NULL,
    "count" INTEGER NOT NULL DEFAULT 1,

    CONSTRAINT "SearchImpressionStat_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "SearchStat_query_date_isTag_key" ON "SearchStat"("query", "date", "isTag");

-- CreateIndex
CREATE UNIQUE INDEX "ProfileViewStat_companyId_date_key" ON "ProfileViewStat"("companyId", "date");

-- CreateIndex
CREATE UNIQUE INDEX "SearchImpressionStat_companyId_date_key" ON "SearchImpressionStat"("companyId", "date");
...
-- AddForeignKey
ALTER TABLE "ProfileViewStat" ADD CONSTRAINT "ProfileViewStat_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "CompanyProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SearchImpressionStat" ADD CONSTRAINT "SearchImpressionStat_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "CompanyProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
