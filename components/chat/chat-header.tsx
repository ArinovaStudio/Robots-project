  ...
  return (
    <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white/50 backdrop-blur-sm z-10 shrink-0">
      <div className="flex items-center gap-4">
        <Link href="/messages" className="xl:hidden p-2 -ml-2 text-slate-400 hover:text-slate-600 rounded-full hover:bg-slate-50 transition">
          <ArrowLeft size={20} />
        </Link>

        {/* Avatar */}
        <div className="relative">
          <div className="size-12 rounded-2xl overflow-hidden bg-slate-50 border border-slate-100 shrink-0 relative">
